...
const urlsToCache = [
  ...
  '/geannynails/vendor/react.production.min.js',
  '/geannynails/vendor/react-dom.production.min.js',
  '/geannynails/vendor/babel.min.js',
  '/geannynails/vendor/bcrypt.min.js',
  '/geannynails/vendor/tailwind-browser.js',
  '/geannynails/vendor/lucide/lucide.css',
  '/geannynails/vendor/lucide/lucide.woff2',
  '/geannynails/utils/push-config.js',
  '/geannynails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/geannynails/icons/icon-192x192.png',
    badge: '/geannynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/geannynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/geannynails/admin.html';
  event.waitUntil(
